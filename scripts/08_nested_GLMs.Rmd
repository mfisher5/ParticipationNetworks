...
Run nested generalized linear models (GLMs) for each network statistic. Code and GLM structure based on modeling conducted by Sunny Jardine for Jardine et al. (2020) doi: [10.1016/j.ecolecon.2020.106691](https://doi.org/10.1016/j.ecolecon.2020.106691).
